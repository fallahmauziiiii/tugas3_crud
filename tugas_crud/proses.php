<?php
    ...
    if(isset($_POST['aksi'])){
        ...
        $sql = "INSERT INTO pendaftaran (nama, alamat, jenis_kelamin, agama, sekolah, tanggal_lahir, no_tel, email, desa, kecamatan, kota, provinsi, kode_pos) 
        ...
        $sekolah = $_POST['sekolah'];
        $tl_mysql = date("y-m-d" , strtotime ($tl));
        $sql ="UPDATE pendaftaran SET nama='$nama',alamat='$alamat',jenis_kelamin='$jk',agama='$agama',sekolah='$sekolah',
